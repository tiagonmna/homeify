...
<html>
    ...
    <body>
        ...
        <section class="form7 cid-spVZDK9FzS" id="form7-10">
            <h3 class="align-center display-5 mb-0 mbr-fonts-style mbr-section-title">Preenche este formulário para alterar a tua Password.</h3>
            <div class="container">
                    ...
                    <div class="col-lg-5 wrapper">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
                            <div class="form-group">
                                <label class="mbr-text mbr-fonts-style display-7">Nova Password</label>
                                <input type="password" name="new_password" class="form-control <?php echo (!empty($new_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $new_password; ?>">
                                <span class="invalid-feedback"><?php echo $new_password_err; ?></span>
                            </div>
                            <div class="form-group">
                                <label class="mbr-text mbr-fonts-style display-7">Confirmar a Password</label>

...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = "Por favor, adiciona uma nova password.";     
    ...
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = "Por favor, confirma a password.";
    } else{
        $confirm_password = trim($_POST["confirm_password"]);
        if(empty($new_password_err) && ($new_password != $confirm_password)){
            $confirm_password_err = "As passwords têm de ser iguais.";
        }
    }
    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "Ups! Alguma coisa correu mal. Tenta novamente mais tarde!";
            }

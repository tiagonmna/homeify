...
if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {
    header("location: /homeify/website/quem_somos.php");
    exit;
}
?>
...
<body>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="content-wrap">
                            <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                <strong>Tiago Fonseca</strong>
                            </h5>
                            <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4">
                                <strong>Músico, Junior Cloud Engineer</strong>
                            </h6>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card-wrap">
                        ...
                        <div class="content-wrap">
                            <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                <strong>Giovanna Damasceno</strong>
                            </h5>
                            <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4">
                                <strong>Cenas</strong>
                            </h6>
                            <p class="card-text mbr-fonts-style align-center display-7">
                                cenas cenas cenas cenas cenas cenas cenas
                            </p>
                            <div class="social-row display-7">
                                <div class="soc-item">
                                    <a href="https://www.facebook.com/Mobirise/" target="_blank">
    ...
    <section class="footer1 cid-spVNvGeVDB" once="footers" id="footer1-11">

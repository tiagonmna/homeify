...
<html>
    ...
    <body class=" pb-5 pt-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                            <li class="nav-item dropdown open">
                                <a class="display-4 dropdown-toggle link nav-link text-black text-primary" data-toggle="dropdown-submenu" aria-expanded="true" href="#"><span class="material material-home mbr-iconfont mbr-iconfont-btn"></span>HOME</a>
        ...
        <section class=" cid-su587ieoee gallery3 mb-5 mt-5 pb-5" id="gallery3-1h">
            <p><p></p></p>
            <div class="container-fluid d-block text-center">
                <div class="mbr-section-head">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong class="float-none">Gostas de música? O teu lugar é aqui!</strong></h4>
                ...
                <div class="row mt-4">
                    <div class="item features-image сol-12 col-md-6 col-lg-3">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="assets/images/netflix-720x405-1-561x316.jpg" alt="" class="p-auto">
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-7"><strong>Os teus concertos</strong></h5>
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Os próximos concertos disponíveis para ti!<br><br></p>
                            </div>
                        </div>
                    </div>
                    <div class="item features-image сol-12 col-md-6 col-lg-3">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="assets/images/130587745-2787835658096692-9189331849246073688-n-561x374.jpg" alt="sopa_de_pedra_1">
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-7"><strong>Artistas que segues</strong></h5>
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">
                            Aqui podes ver uma lista dos artistas que segues, assim como os seus próximos concertos e álbuns.<br></p>
                            </div>
                        </div>
                    </div>
                    <div class="item features-image сol-12 col-md-6 col-lg-3">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="assets/images/conanosiris-coliseu2019-fredgomes-27-scaled-561x374.jpg" alt="conan_1">
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-7"> <strong>Galeria</strong></h5>
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">
                            Vê os novos conteúdos que temos disponíveis para ti. Não vais querer perder <em>NADA</em>!<br></p>
                            </div>
                        </div>
                    </div>
                    <div class="item features-image сol-12 col-md-6 col-lg-3">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <img src="assets/images/foto-2-561x425.jpeg" alt="manel_cruz" title="">
                            </div>
                            <div class="item-content">
                                <h5 class="item-title mbr-fonts-style display-7"><strong>Recomendação da casa...</strong></h5>
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">
                            Vê os artistas e concertos que te sugerimos com base nas tuas preferências...&nbsp;</p>
                            </div>
                        </div>
                    </div>
                </div>

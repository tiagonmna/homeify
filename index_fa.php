...
if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true || $_SESSION["tipo"] !== "fa" ) {
...
<html>
    ...
    <body>
        ...
        <section class="d-flex header1" id="header1-f">
            <img src="assets/images/pexels-josh-sorenson-976863.jpg" class="h-auto position-absolute rounded-0 vw-100">
